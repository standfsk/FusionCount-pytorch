...
from dataset.crowd import Crowd_, Crowd_no
...
class Trainer(object):
    ...
    def setup(self):
        ...
        self.logger = log_utils.get_logger(os.path.join(self.save_dir, 'debug.log'.format(time_str)))
        ...
        downsample_ratio = 8
        self.datasets = {x: Crowd_(os.path.join('dataset', args.dataset, x), args.crop_size, downsample_ratio, x) for x in ['train', 'val']}
