...
def get_args_parser():
    ...
    parser.add_argument('--weight_path', type=str, default='ckpt/ucfcc/best_model.pth',
...
def main(args):
    ...
    dataset = crowd.Crowd_no(os.path.join('dataset', dataset_name, 'test'), args.crop_size, 8, method='test')
    ...
    onnx_sim, check = simplify(onnx_model, skip_shape_inference=True)
